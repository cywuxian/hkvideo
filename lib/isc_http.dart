...
class IscApi {
  ...
  static Future<dynamic> getPreviewURL({
    ...
    String url = 'https://${ArtemisConfig.host}$previewURLs';
  ...
  static Future<dynamic> getPlaybackUrl({
    ...
    String url = 'https://${ArtemisConfig.host}$playbackURLs';
  ...
  ///
  /// GOTO_PRESET到预置点
  static Future<dynamic> ptzControl(String cameraIndexCode,
      int action,
    ...
    String url = 'https://${ArtemisConfig.host}$controllingV1';
